...
import hxex.MAextensions;

using StringTools;
using hxex.MAextensions;
...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		// quick test to make sure all the extended functions works.
		var sample:Array<Int> = [1, 2, 3, 4, 5];
		trace(sample.contains(5));
		
		var sample2:Map<String, Int> = new Map<String, Int>();
		sample2.set('Wassup', 8);
		sample2.set('NO', 4);
		
		var sample3:Map<String, Int> = new Map<String, Int>();
		sample2.mCopy(sample3);
		
		trace(sample2 + " ok and " + sample3);
